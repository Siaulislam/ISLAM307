...
class _TafsirScreenState extends ConsumerState<TafsirScreen> {
  final _tafsirRepo = TafsirRepository(DatabaseRegistry.instance);
  ...
  Future<void> _boot() async {
    ...
    final installed = sources.where((s) => s['installed'] == true).toList();
    final slug = sources.any((s) => s['slug'] == preferred)
        ? preferred
        : (installed.isNotEmpty ? installed.first['slug'] as String : sources.first['slug'] as String);
    if (!mounted) return;
    setState(() {
      _sources = sources;
      _surahs = surahs;
    ...
    return Scaffold(
      ...
      body: _loading
          ...
          : ListView(
              ...
              children: [
                const Text(
                  'Select Surah, Ayah, and an authentic tafsir source. Content is never generated by AI.',
