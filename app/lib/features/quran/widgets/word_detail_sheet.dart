      ...
      child: SizedBox(
        ...
        child: ListView(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            const Text('AI وضاحت (صرف مقامی ڈیٹا)', style: TextStyle(fontWeight: FontWeight.w800, color: Islam307Theme.emeraldDeep)),
            const SizedBox(height: 8),
            Container(
              ...
              child: Text(w.localAiExplanation(lang: lang), style: const TextStyle(height: 1.55, fontSize: 13)),
            ),
            const SizedBox(height: 10),
